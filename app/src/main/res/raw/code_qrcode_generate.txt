...
public class QRcodeGenerateExample extends AppCompatActivity {
...
// Don't change END
    ...
    public static final String EFFECT_ACTIVITY_NAME = ".demos.QRcodeGenerateExample";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // Change here to the layout name
        setContentView(R.layout.activity_qrcode_generate_example);
