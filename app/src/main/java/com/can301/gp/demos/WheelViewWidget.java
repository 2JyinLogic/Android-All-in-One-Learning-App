...
public class WheelViewWidget extends AppCompatActivity {
...
// Don't change END
    ...
    public static final String EFFECT_ACTIVITY_NAME = ".demos.WheelViewWidget";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // Change here to the layout name
        setContentView(R.layout.content_wheel_view_widget);
