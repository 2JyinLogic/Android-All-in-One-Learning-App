...
// Don't change END
    ...
    public static final String EFFECT_ACTIVITY_NAME = ".demos.SeekBarWidget";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView display1 = findViewById(R.id.textView9);
        TextView display2 = findViewById(R.id.textView10);
