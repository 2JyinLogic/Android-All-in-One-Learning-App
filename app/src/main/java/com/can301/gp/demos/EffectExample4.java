...
public class EffectExample4 extends AppCompatActivity {
...
// Don't change END
    ...
    public static final String EFFECT_ACTIVITY_NAME = ".demos.EffectExample4";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // Change here to the corresponding layout name
        setContentView(R.layout.activity_effect_example4);
